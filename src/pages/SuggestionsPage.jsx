    ...
    <div style={{ background: KW.bg, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '40px var(--kw-page-x)' }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{ font: '700 9px var(--kw-mono)', color: KW.pink, letterSpacing: '.24em', textTransform: 'uppercase', marginBottom: 10 }}>
            feedback
          </div>
          <h1 style={{ font: '700 32px/1 var(--kw-mono)', color: KW.text, margin: '0 0 10px' }}>suggestions.</h1>
          <div style={{ font: '400 12px/1.7 var(--kw-mono)', color: KW.text3, maxWidth: 640 }}>
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <Button variant="secondary" onClick={() => navigate('/login', { state: { from: '/suggestions' } })}>log in →</Button>
          </div>
        ) : (
