  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, padding: "20px 24px 32px" }}>
        ...
        <a
          href="/builds"
          onClick={(e) => { e.preventDefault(); navigate("/builds"); }}
          style={{
            font: "400 10px var(--kw-mono)", color: KW.text3,
            textDecoration: "none", cursor: "pointer",
            transition: "color .18s", display: "inline-block", marginBottom: 22,
          }}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
          ...
          <Bubble title="builder's notes.">
            <div style={{ font: "400 11px/1.8 var(--kw-mono)", color: KW.text2 }}>
              {BUILD.notes.map((p, i) => (
                <p key={i} style={{ margin: i === BUILD.notes.length - 1 ? 0 : "0 0 12px" }}>{p}</p>
              ))}
            </div>
            <div style={{
              ...
              <span style={{ font: "700 9px var(--kw-mono)", color: KW.text3, letterSpacing: ".12em" }}>
                OVERALL RATING
              </span>
            ...
            <div style={{ font: "400 10px var(--kw-mono)", color: KW.text4, marginTop: 4, textAlign: "right" }}>
